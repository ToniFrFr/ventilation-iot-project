...
```
cd existing_repo
git remote add origin https://gitlab.metropolia.fi/embedded-iot-project/iot-project-server-side.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.metropolia.fi/embedded-iot-project/iot-project-server-side/-/settings/integrations)
